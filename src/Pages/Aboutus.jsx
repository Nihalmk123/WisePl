            ...
            <div className="row">
              ...
              <div className="col-md-6" style={{ marginTop: "60px" }}>
                ...
                <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#333' }}>
                  WISE PL is proudly operated by PL Education Centre, established in 1994 by Mr. Peter SP Lim. Our center
                  is located at Block 121, Bukit Merah Lane 1, #01-12, Singapore 150121, conveniently situated opposite
                  Queensway Shopping Centre and IKEA (Alexandra).
                </p>
                <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#333' }}>
      ...
      <div className="row">
        ...
        <section className="section gb" style={{ paddingBottom: 'px', backgroundColor: '#f9f9f9' }}>
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <h1 className="section-title text-center" >Our Offerings</h1>
              </div>
